...
<div className='flex w-screen overflow-scroll h-min z-50'>
    ...
    <img className="p-2 flex w-2/12 h-1/6  duration-500 hover:drop-shadow-[0_0px_5px_#30ff35] " onClick={() => router.push('/miserysite')} src="https://i.ibb.co/37Sd6XV/Layer-1.png"/>
    ...
    <img className="p-5 flex w-2/12 h-1/6  duration-500 hover:drop-shadow-[0_0px_5px_#3d00f5] " onClick={() => router.push('/eventsupcoming')} src="https://i.ibb.co/PC6ndJ5/Layer-3.png"/>
    <img className="p-4 flex w-5/12 h-1/6  duration-500 hover:drop-shadow-[0_0px_5px_green] " onClick={() => router.push('/madebymisery/made-by-misery')} src="https://i.ibb.co/tXp19yy/Layer-4.png"/>
    <img className="p-5 flex  w-3/12 h-1/6 rotate-2  duration-500 hover:drop-shadow-[0_0px_5px_#3d9335]"  onClick={() => router.push('/resources/resources-for-qtibpoc-healing')} src="https://i.ibb.co/V25jWY5/Layer-5.png"/>
    {/* newsec */}
    <img className="p-4 flex w-3/12 h-1/6   duration-500 hover:drop-shadow-[0_0px_5px_red] " onClick={() => router.push('../press/press')} src="https://i.ibb.co/mCW1MxP/Layer-6.png"/>
    <img className="p-4 flex w-3/12 h-1/6  duration-500 hover:drop-shadow-[0_0px_5px_pink]  " onClick={() => router.push('../getinvolved/get-involved')} src="https://i.ibb.co/s3Mfn3q/Layer-7.png"/>
    <img className="p-4 flex w-3/12 h-1/6  duration-500 hover:drop-shadow-[0_0px_5px_yellow] " onClick={() => router.push('/contact/contact')} src="https://i.ibb.co/6FJhfp7/Layer-8.png"/>
    <img className=" p-4 flex w-2/12 h-1/6   duration-500 hover:drop-shadow-[0_0px_5px_blue] " onClick={() => router.push('/Shop')} src="https://i.ibb.co/g7LwM63/Layer-9.png"/>
